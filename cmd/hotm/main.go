...
func main() {
	...
	level3Grid := flag.Bool("level3grid", false, "play the extracted Level 3 grid (41 real, fully-connected cells) instead of CollodonsPile")
	...
	case *level3Grid:
		...
		fmt.Println("Real, validated, fully-connected 41-cell Level 3 map (world.Level3Grid) — not merged with CollodonsPile yet.")
